...
# by defaul this role will attempt to activate the EPEL repository on CentOS by
# installing the epel-release package. Set this to false, if this is not needed
# on your system
nginx_install_epel: yes
```
