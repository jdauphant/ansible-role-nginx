...
# A list of hashs that define additional configuration snippets
nginx_snippets:
  php-fpm:
...
5) Install Nginx, add 1 site, add additional snippets and use them in the site configuration
